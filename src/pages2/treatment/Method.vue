		...
		<section class="right-main">
			<section class="tools">
				<el-form :inline="true" :model="formInline" class="demo-form-inline">
					<el-form-item label="所有治疗方法">
						<el-input v-model="formInline.user" placeholder="搜索治疗方法"></el-input>
					</el-form-item>
			...
			<section>
				<el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" stripe style="width: 100%" @selection-change="handleSelectionChange" header-cell-class-name="top-bar" v-loading="loading">
					...
					<el-table-column prop="treatment" label="治疗方法" align="center">
					</el-table-column>
					<el-table-column prop="coded" label="治疗方法编码" align="center">
					</el-table-column>
